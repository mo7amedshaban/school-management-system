    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('onlineclasse.delete')}} {{$online_classe->topic}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('online_classes.destroy','test')}}" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button  class="btn btn-danger">{{trans('onlineclasse.sure')}}</button>
                    </div>
                </form>
            </div>
        </div>
